 ...
 * Cross-grade scope is limited to the active school family (ELEMENTARY or
 * MIDDLE) via lib/grades.ts familyOf — same as production GRADE_ORDER.
 * No network / AI / embeddings / external search stores.
 */
